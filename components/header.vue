    ...
    <header class="header">
            <div class="header__logo">
                ...
                <template v-else-if="menu?.length && screenWidth <= 762">
                    <svg @click="showMenu = true" class="menu"   width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 7H21" stroke="#043B40" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M3 12H21" stroke="#043B40" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M3 17H21" stroke="#043B40" stroke-width="1.5" stroke-linecap="round"/>
                    </svg>
                </template>
            </div>
